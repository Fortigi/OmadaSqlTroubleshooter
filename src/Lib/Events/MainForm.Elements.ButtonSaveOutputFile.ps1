$Script:MainFormForm.Elements.ButtonSaveOutputFile.Add_Click({
        try {
            $_ | Show-EventInfo
            ...
            $SaveFileDisplayName = $Script:MainFormForm.Elements.TextBoxDisplayName.Text
            ...
            if ($SaveFileDialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
                ...
                $Script:MainFormForm.Elements.ButtonOpenOutputFile.IsEnabled = $true
            }
            else {
