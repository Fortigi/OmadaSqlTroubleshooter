...
#         try {
#
#             if ($Script:RunTimeData.CurrentSqlQuery.DisplayName.Split(" - ")[1] -eq $Script:MainForm.Elements.TextBoxDisplayName.Text) {
#                 "DisplayName not changed" | Write-LogOutput -LogType DEBUG
#                 return
#             }
#             $QueryExists = $true
#             if ($Script:MainForm.Elements.TextBoxDisplayName.Text -notin $Script:RunTimeData.QueryListCache.QueryList.Values) {
...
#             }
#             if ($QueryExists) {
#                 $Script:MainForm.Elements.ButtonNewQuery.Content = "Delete"
#             }
#             else {
#                 $Script:MainForm.Elements.ButtonNewQuery.Content = "New"
#             }
#         }
#         catch {
