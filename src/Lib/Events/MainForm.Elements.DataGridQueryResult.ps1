# $Script:MainFormForm.Elements.DataGridQueryResult.Add_PreviewKeyDown({
...
#                 try {
#                     $ClipboardText = ""
#                     $SelectedCells = $Script:MainFormForm.Elements.DataGridQueryResult.SelectedCells
#                     $SelectedItems = $Script:MainFormForm.Elements.DataGridQueryResult.SelectedItems

#                     # Check if we have a "select all" scenario by looking at current cell and selection
#                     $CurrentCell = $Script:MainFormForm.Elements.DataGridQueryResult.CurrentCell
#                     $IsSelectAll = ($SelectedItems.Count -eq 0 -and $SelectedCells.Count -eq 0 -and
#                         $Script:MainFormForm.Elements.DataGridQueryResult.Items.Count -gt 0) -or
...
#                         $AllItems = $Script:MainFormForm.Elements.DataGridQueryResult.Items
#                         $Columns = $Script:MainFormForm.Elements.DataGridQueryResult.Columns
...
# $Script:MainFormForm.Elements.DataGridQueryResult.Add_MouseDoubleClick({
#         [System.Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidAssignmentToAutomaticVariable', 'EventArgs', Justification = 'The use of the variable is on purpose')]
#         param(
#             $EventSender,
#             $EventArgs
...
#             $HitTest = [System.Windows.Media.VisualTreeHelper]::HitTest($Script:MainFormForm.Elements.DataGridQueryResult, $EventArgs.GetPosition($Script:MainFormForm.Elements.DataGridQueryResult))
...
$Script:MainFormForm.Elements.DataGridQueryResult.Add_LoadingRow({
        param(
            $EventSender,
            $EventArgs
        )
