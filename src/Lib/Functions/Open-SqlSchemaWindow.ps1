function Open-SqlSchemaWindow {
    try {
        ...
        $Script:SqlSchemaWindowForm.Definition.Add_LocationChanged({
                ...
                if (!$Script:PositionManagerSqlSchemaWindow.Synchronizing) {
                    ...
                    $Script:SqlSchemaWindowForm.Definition.Dispatcher.Invoke({
                            $Script:PositionManagerSqlSchemaWindow.PositionOffSetTop = [Int]::Abs($Script:MainWindowForm.Definition.Top) - [Int]::Abs($Script:SqlSchemaWindowForm.Definition.Top)
                            ...
                            $Script:PositionManagerSqlSchemaWindow.PositionOffSetLeft = [Int]::Abs($Script:MainWindowForm.Definition.Left) - [Int]::Abs($Script:SqlSchemaWindowForm.Definition.Left)
        ...
        #                 $Script:PositionManagerSqlSchemaWindow.PositionOffSetTop = $Script:SqlSchemaWindowForm.Definition.Top - [Int]$MainWindowForm.Definition.Top
        ...
        #         [Int]$Script:PositionManagerSqlSchemaWindow.PositionOffSetLeft = $Script:SqlSchemaWindowForm.Definition.Left + $Script:SqlSchemaWindowForm.Definition.Width + 2
        #         $Script:PositionManagerSqlSchemaWindow.PositionOffSetTop = $Script:SqlSchemaWindowForm.Definition.Top - [Int]$MainWindowForm.Definition.Top
        #     })
