function Set-EditorValue {
    ...
    try {
        ...
        if ($null -ne $Script:MainFormForm.Elements.ComboBoxSelectQuery.SelectedItem) {
            "Selected SQL Query object: {0}" -f $Script:MainFormForm.Elements.ComboBoxSelectQuery.SelectedItem.Content | Write-LogOutput -LogType DEBUG
            $Script:MainFormForm.Elements.ComboBoxSelectQuery.SelectedItem.Content | Set-ConfigProperty -Property "CurrentSqlQuery"
            ...
            if ($null -ne $Private:Result) {
                ...
                $Script:MainFormForm.Elements.TextBoxDisplayName.Text = $Private:Result.DisplayName
