function Open-SqlSchemaForm {
    ...
    try {
        ...
        $Script:SqlSchemaForm = Initialize-FormObject -FormPath (Join-Path $Script:RunTimeConfig.ModuleFolder -ChildPath "lib\ui\SqlSchemaForm.xaml") -ParentForm $Script:MainFormForm.Definition
        ...
        $Script:SqlSchemaForm.Definition.Add_LocationChanged({
                ...
                if (!$Script:SqlSchemaForm.PositionManager.Synchronizing) {
                    ...
                    $Script:SqlSchemaForm.Definition.Dispatcher.Invoke({
                            $Script:SqlSchemaForm.PositionManager.PositionOffSetTop = [Int]::Abs($Script:MainFormForm.Definition.Top) - [Int]::Abs($Script:SqlSchemaForm.Definition.Top)
                            ...
                            $Script:SqlSchemaForm.PositionManager.PositionOffSetLeft = [Int]::Abs($Script:MainFormForm.Definition.Left) - [Int]::Abs($Script:SqlSchemaForm.Definition.Left)
        ...
        $Script:SqlSchemaForm.Definition.Add_SizeChanged({
                $_ | Show-EventInfo -LogType VERBOSE2
                $Script:SqlSchemaForm.Size = $Script:SqlSchemaForm.Definition | Get-WindowSize
            })

        #endregion

        if ($null -ne ($Script:SqlSchemaForm.Definition | Get-WindowPositionConfig)) {
            $Position = $Script:SqlSchemaForm.Definition | Get-WindowPositionConfig
        ...
        #         $Script:SqlSchemaForm.PositionManager.Synchronizing = $true
        #         $Script:SqlSchemaForm.Definition.Dispatcher.Invoke({
        #                 $Script:SqlSchemaForm.Definition.Top = $Script:MainFormForm.Definition.Top
        #                 $Script:SqlSchemaForm.Definition.Left = $Script:MainFormForm.Definition.Left - $Script:MainFormForm.SqlSchemaForm.Width
        #                 $Script:SqlSchemaForm.PositionManager.PositionOffSetTop = $Script:SqlSchemaForm.Definition.Top - [Int]$MainFormForm.Definition.Top
        ...
        #                 if ($null -ne ($Script:SqlSchemaForm.Definition | Get-WindowSizeConfig)) {
        #                     $Size = $Script:SqlSchemaForm.Definition | Get-WindowSizeConfig
        ...
        #                 $Script:SqlSchemaForm.PositionManager.Synchronizing = $false
        #             }, [System.Windows.Threading.DispatcherPriority]::Render)
        #         $Script:MainFormForm.Elements.ButtonShowSqlSchemaText | Set-ButtonText -Value "Hide S_ql Schema"
        ...
        $Script:SqlSchemaForm.Definition.Add_Loaded({
                ...
                $Script:SqlSchemaForm.PositionManager.Synchronizing = $true
                $Script:SqlSchemaForm.Definition.Dispatcher.Invoke({
                        $Script:SqlSchemaForm.Definition.Top = [Int]::Abs($Script:MainFormForm.Definition.Top)
                        ...
                        $Script:SqlSchemaForm.Definition.Left = [Int]::Abs($Script:MainFormForm.Definition.Left) - [Int]::Abs($Script:SqlSchemaForm.Definition.Width)
