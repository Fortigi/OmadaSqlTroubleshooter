function Open-SqlHistoryForm {
    ...
    try {
        ...
        $Script:SqlHistoryForm = Initialize-FormObject -FormPath (Join-Path $Script:RunTimeConfig.ModuleFolder -ChildPath "lib\ui\HistoryForm.xaml") -ParentForm $Script:MainFormForm.Definition
        ...
        $Script:SqlHistoryForm.Definition.Add_SizeChanged({
                ...
                $Script:SqlHistoryForm.Size = $Script:SqlHistoryForm.Definition | Get-WindowSize
            })

        if ($null -ne ($Script:SqlHistoryForm.Definition | Get-WindowPositionConfig)) {
            $Position = $Script:SqlHistoryForm.Definition | Get-WindowPositionConfig
