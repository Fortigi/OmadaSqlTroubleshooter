...
function Invoke-OmadaSqlTroubleshooter {
    ...
    $Script:MainFormForm = Initialize-FormObject -FormPath (Join-Path $Script:RunTimeConfig.ModuleFolder -ChildPath "lib\ui\MainForm.xaml") -AppendVersion

    $Script:RunTimeConfig.ApplicationTitle = $Script:MainFormForm.Definition.Title.ToString()
    "Get WebView" | Write-LogOutput -LogType DEBUG
    $Script:Webview.Object = $Script:MainFormForm.Definition.FindName("webView21")
    #endregion
    ...
    Initialize-FormEvents -FormName "MainFormForm"
    ...
    try {
        ...
        [void]$Script:MainFormForm.Definition.ShowDialog()
        ...
        elseif ($null -ne $Script:MainFormForm.Elements.TextBoxPassword.Password) {
        ...
        $Script:MainFormForm.Definition.Close() | Out-Null
